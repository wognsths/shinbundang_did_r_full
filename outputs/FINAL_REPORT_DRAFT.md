...
Permutation 결과는 `outputs/identification/tables/subway_permutation_pvalue.csv`에 저장된다. Permutation p-value가 conventional p-value(0.057)와 크게 다르다면, 기본 결과의 통계적 유의성에 대해 더 보수적으로 해석해야 한다.
