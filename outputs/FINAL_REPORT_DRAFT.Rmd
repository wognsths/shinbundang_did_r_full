...
knitr::include_graphics("dag_controls/figures/dag_identification.png")
```

```{r fig-dag-robustness, fig.cap='DAG 기반 통제변수 robustness DID 추정치'}
knitr::include_graphics("dag_controls/figures/did_control_robustness.png")
```
...
knitr::include_graphics("creative_hypotheses/figures/subway_direction_timeband_effects.png")
```

```{r fig-commerce-three-group, fig.cap='Anchor, secondary corridor, control 상권 매출 추세'}
knitr::include_graphics("less_central/figures/commerce_three_group_sales_trend.png")
```

```{r fig-commerce-age, fig.cap='Secondary corridor 소비자 구성 DID 추정치'}
knitr::include_graphics("creative_hypotheses/figures/commerce_secondary_age_gender_effects.png")
```

```{r fig-bus-corridor, fig.cap='신분당선 corridor 인근 버스 정류장 DID 추정치'}
knitr::include_graphics("reallocation_extensions/figures/bus_corridor_did_effects.png")
```

```{r fig-living-composition, fig.cap='Secondary corridor 생활인구 구성 DID 추정치'}
knitr::include_graphics("reallocation_extensions/figures/living_secondary_composition_effects.png")
```

```{r fig-subway-daygroup, fig.cap='요일군별 지하철 DID 추정치'}
knitr::include_graphics("reallocation_extensions/figures/subway_daygroup_effects.png")
```

```{r fig-gyeonggi-trend, fig.cap='분당구 원 신분당선 corridor와 통제동의 활동인구 추세'}
knitr::include_graphics("gyeonggi_api/figures/gyeonggi_bundang_activity_trend.png")
```

```{r fig-gyeonggi-did, fig.cap='경기도 API 활동인구 DID 추정치'}
knitr::include_graphics("gyeonggi_api/figures/gyeonggi_bundang_did_effects.png")
```

```{r fig-gyeonggi-dong, fig.cap='원 신분당선 corridor 개별 행정동 활동인구 DID 추정치'}
knitr::include_graphics("gyeonggi_api/figures/gyeonggi_bundang_single_dong_effects.png")
```
